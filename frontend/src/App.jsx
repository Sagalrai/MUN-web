...
function RegistrationPage() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('qrmun_token', result.accessToken);
...
function PaymentSuccess() {
  ...
  const [delegateId, setDelegateId] = useState('DEL-0001');
...
function App() {
  ...
  useEffect(() => {
    ...
    api('/auth/me').then(setAdmin).catch(() => localStorage.removeItem('qrmun_token')).finally(() => setTimeout(() => setChecking(false), 0))
  }, [location.pathname]);
